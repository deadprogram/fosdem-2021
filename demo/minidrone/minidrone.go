...
func (m *Minidrone) FrontFlip() (err error) {
...
func (m *Minidrone) BackFlip() (err error) {
...
func (m *Minidrone) RightFlip() (err error) {
...
func (m *Minidrone) LeftFlip() (err error) {
